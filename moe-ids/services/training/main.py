...
from services.training.routes_health import router as health_router
from services.training.routes_train import router as train_router


def create_app() -> FastAPI:
    configure_logging()
    app = FastAPI(
        title="MoE IDS — Training Service",
        version="0.1.0",
    )
